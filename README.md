...
In your **back/src/main/resources/application.properties**, make sure you have the correct database configuration.
...
-   MySQL must be running for the back-end to connect to the database. Otherwise the database will fail to connect.
...
- Run the tests for the back-end application with:
...
- Generate the coverage reports for the back-end application with:
  ...
  This runs the existing unit and integration tests and generates separate coverage reports via JaCoCo.

- Open the folder **target/site** in your file explorer.

  The generated coverage reports for all tests and integration tests via JaCoCo can be found here.
  ...
  Open the files **index.html** in a browser to view the coverage reports.
...
- Select a browser and click on the button `Start E2E Testing in Chrome`.
...
To do so, you can follow the documentation: https://learning.postman.com/docs/getting-started/importing-and-exporting-data/#importing-data-into-postman
